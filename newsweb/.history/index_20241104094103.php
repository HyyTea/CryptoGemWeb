...
<div class="px-5 py-5">
    ...
    <?php
if (strpos($featuredVideo['PostVideo'], 'youtube.com') !== false) {
    $videoUrl = $featuredVideo['PostVideo'];
    // Lấy video ID từ URL
...
} elseif (strpos($featuredVideo['PostVideo'], 'vimeo.com') !== false) {
    // Xử lý video Vimeo nếu cần
} else {
