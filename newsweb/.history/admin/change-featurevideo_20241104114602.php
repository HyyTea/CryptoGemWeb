...
{ 
    ...
    if (isset($_POST['update'])) {
        ...
        if (!empty($postVideo) || !empty($_FILES['uploadvideo']['name'])) {
            ...
            // Kiểm tra nếu người dùng tải lên video
            if (!empty($_FILES['uploadvideo']['name'])) {
                $targetDir = "featurepostvideo/"; // Thư mục lưu trữ video
                ...
                if (in_array($videoFileType, $allowedTypes)) {
                    ...
                    echo "<script>alert('Invalid video format. Only MP4, AVI, MOV, WMV, FLV, and MKV formats are allowed.');</script>";
                    return;
                }
            }
