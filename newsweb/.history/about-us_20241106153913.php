    ...
    <div style="margin-top: 4%">
        ...
        <div class="px-5 py-5">
            ...
            <div class="col-md-12 d-flex justify-content-between">
                <div class="col-md-4">
                    <div class="border border-secondary p-5 rounded-pill" style="border-color: gray;">
                        
                    “Our stay at OakHill was magical. Cozy rooms, breathtaking views, and attensive staff. A hidden gem we’ll definitely revisit. Thank you for an unforgettable escape.”
    
                            <div class="text-right mt-2" style="font-size: 14px; color: gray;">
                                - Chief Analyst
                            </div>
                    </div>
                </div>
