        ...
        if (!empty($postVideo)) {
            ...
            if (strpos($postVideo, '<iframe') !== false) {
                ...
                if (!filter_var($postVideo, FILTER_VALIDATE_URL)) {
                    echo "<script>alert('12Invalid video format. Please provide a valid URL or embed code.');</script>";
                    return;
                }
            }
            ...
            echo "<script>alert('35Invalid video format. Please provide a valid URL, embed code, or upload a video file.');</script>";
        }
    }
