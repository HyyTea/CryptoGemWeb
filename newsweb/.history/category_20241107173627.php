      ...
      <div class="col-md-8">
        ...
        <div class="px-5 py-5">
          ...
          <div class="row" style="gap: 20px;">
            ...
            ?>
              <div class="custom-col mb-4 d-flex">
                <a href="news-<?php echo $postType;?>details.php?nid=<?php echo htmlentities($postId);?>" class="text-decoration-none text-dark" style="display: block;">
                  <div style="border: 1px solid #ccc; padding: 0; max-height: 100%; border-radius: 5%; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); height: 100%;">
                    <div class="overflow-hidden" style="height: 250px; width: 100%; border-radius: 5%;">
                    ...
                    <div style="padding: 10px; color: black; flex-grow: 1;">
                      <h5 style="font-size: 16px; font-weight: bold;"><?php echo htmlentities($postTitle);?></h5>
