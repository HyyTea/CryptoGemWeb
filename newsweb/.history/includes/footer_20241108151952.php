...
<script>
    function subscribeNewsletter() {
        ...
        if (email) {
            console.log('Đang gửi dữ liệu:', email); // Kiểm tra email đã lấy được đúng chưa
            
            fetch('includes/subscriber.php', {
                method: 'POST',
                headers: {
            ...
            .catch(error => {
                console.error('Lỗi khi gửi yêu cầu:', error); // Log lỗi khi có lỗi
