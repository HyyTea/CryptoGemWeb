...
<!-- #region -->
    ...
    .row.d-flex.justify-content-between.flex-wrap {
    ...
    .col-6 {
        width: 100%;
        max-width: 300px; /* Đặt giới hạn chiều rộng cho mục để không bị quá lớn */
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Charts"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px;">
                    <img class="card-img-top h-auto" src="admin/mainpostimages/Category1.jpg" alt="Charts">
                </div>
