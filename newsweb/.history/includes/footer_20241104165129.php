    ...
    <div class="px-5 py-5">
        <div class="row">
            <div class="col-lg-6 mb-4">
                ...
                <div class="mt-3">
                    <label for="newsletter-email" class="d-block" style="font-size: 1.25rem;">Email</label>
                    <input type="email" placeholder="YOUR EMAIL"
                           class="form-control bg-white text-dark border-0" id="newsletter-email"
                           style="border: none; box-shadow: none; border-bottom: 2px solid #ccc; padding: 0.5rem 0;">
                </div>

                <button class="btn" style="border: 2px solid #28a745; border-radius: 5px; background-color: white; color: #28a745; padding: 10px 20px; margin-top: 10px;" onclick="subscribeNewsletter()">
