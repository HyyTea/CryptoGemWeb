        ...
        <div class="d-flex justify-content-between align-items-center px-4 py-2" style="width: 100%;">
                ...
                <div id="Navbar" class="rounded-pill py-2 d-flex align-items-center" style="border: none; padding: 10px; background-color: #F2F2F2;">
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav mb-0">
                            ...
                            <li class="nav-item" style="margin-right: 20px;">
                                <a class="nav-link text-dark" href="category.php?catid=18">Blockchain</a>
                            </li>
                            <li class="nav-item" style="margin-right: 20px;">
                                <a class="nav-link text-dark" href="category.php?catid=11">Markets</a>
                            </li>
                            <li class="nav-item" style="margin-right: 20px;">
                                <a class="nav-link text-dark" href="category.php?catid=17">Research</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="category.php?catid=13">News</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="ml-3 position-relative">
                <form method="POST" action="search.php" class="d-flex">
                    ...
                    <input type="text" name="searchtitle" id="search-input" class="form-control border rounded-pill position-absolute" placeholder="Search" style="display: none; right: 0; top: 50%; transform: translateY(-50%); width: 200px;" onblur="toggleSearchInput()">
                </form>
            </div>
