            ...
            <div class="custom-col mb-4 d-flex" onclick="playVideo('video-<?php echo $index; ?>')">
                <div class="card">
                    ...
                    if (strpos($post3['PostVideo'], 'youtube.com') !== false || strpos($post3['PostVideo'], 'vimeo.com') !== false) {
                        ...
                        echo '<iframe id="video-' . $index . '" style="max-height: 100%; border-radius: 5%; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); width: 350px;" src="' . htmlentities($videoEmbedUrl) . '" frameborder="0" allowfullscreen></iframe>';
                    } else {
                        // Nếu là video tải lên
                        echo '<video id="video-' . $index . '"  preload="none" controls poster="admin/featurepostimages/' . htmlentities($post3['PostVideo']) . '?t=1" onclick="event.stopPropagation()">
