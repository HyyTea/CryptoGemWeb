            ...
            <div class="custom-col mb-4 d-flex" onclick="playVideo('video-<?php echo $index; ?>')">
                <div class="card">
                    ...
                    if (strpos($post3['PostVideo'], 'youtube.com') !== false || strpos($post3['PostVideo'], 'vimeo.com') !== false) {
                        ...
                        echo '<iframe id="video-' . $index . '" style="max-height: 100%; border-radius: 5%; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); height: 350px; width: 100%;" class="small-video-frame" src="' . htmlentities($videoEmbedUrl) . '" frameborder="0" allowfullscreen></iframe>';
                    } else {
