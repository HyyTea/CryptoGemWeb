...
<div class="py-5">
    ...
    ?>
    <div class="card featured-video" onclick="playVideo('featured-video')" style="max-height: 2500x; height: 650px;">
    <!-- <div class="text-center overlay-content">
        ...
        <div class="video-wrapper">
            ...
            if (strpos($featuredVideo['PostVideo'], 'youtube.com') !== false || strpos($featuredVideo['PostVideo'], 'vimeo.com') !== false) {
                ...
                echo '<iframe id="featured-video" style="max-height: 100%; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); height: 650px;" class="featured-video-iframe" src="' . htmlentities($videoEmbedUrl) . '" frameborder="0" allowfullscreen></iframe>';
            } else {
