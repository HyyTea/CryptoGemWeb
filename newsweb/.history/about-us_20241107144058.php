...
<head>
    ...
    .position-absolute {
        top: 20%; /* Điều chỉnh vị trí của văn bản */
        left: 5%;
        right: 5%;
    ...
    .row.position-relative img {
        width: 80%; /* Giảm kích thước logo để phù hợp với màn hình nhỏ */
        height: auto;
    }
    ...
    <div style="margin-top: 4%">
        ...
        <div class="px-5 py-5">
            <div class="row position-relative">
                ...
                <div class="position-absolute" style="top: 5%; left: 35%; right: 5%; max-width: 70%;">
                    <p>
            ...
            <!-- Why Us Section -->
            <div class="about1 about mt-5 mb-5">
