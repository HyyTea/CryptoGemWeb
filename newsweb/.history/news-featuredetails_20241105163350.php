    ...
    <div class="row" style="margin-top: 4%">
        <div class="post-header">
            ...
            <div class="overflow-hidden" style="height: 100%; max-height: 650px">
              <img class="card-img-top w-100 h-auto" src="admin/featurepostimages/<?php echo htmlentities($row['PostImage']); ?>" alt="<?php echo htmlentities($row['posttitle']); ?>" style="object-fit: cover; height: 100%;">
