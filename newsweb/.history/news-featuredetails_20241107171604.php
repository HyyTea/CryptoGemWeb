...
<head>
    ...
    <?php
      ...
      $pid = intval($_GET['nid7']); // Lấy ID bài viết chính
    ...
    <div class="row" style="gap: 20px;">
        ...
        foreach (array_slice($posts2, 0, 5) as $index => $post2) {
            ...
            echo '<a href="news-featuredetails.php?nid2=' . htmlentities($post2['pid4']) . '" class="text-decoration-none text-dark" style="display: block;">';
