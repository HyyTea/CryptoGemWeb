...
<!-- #region -->
    ...
    @media (max-width: 768px) {
        .col-md-2 {
            width: 48%; /* Điều chỉnh phần tử chiếm 48% chiều rộng trên màn hình nhỏ */
            margin-bottom: 20px;
        }
    ...
    <div class="row d-flex justify-content-between flex-wrap">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Charts"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px; flex: 1 0 18%; max-width: 18%;">
                    <img  style="flex: 1 0 18%; max-width: 18%;" class="card-img-top w-100 h-auto" src="admin/mainpostimages/Category1.jpg" alt="Charts">
                </div>
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("GameFi"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px; flex: 1 0 18%; max-width: 18%;">
                    <img  style="flex: 1 0 18%; max-width: 18%;" class="card-img-top w-100 h-auto" src="admin/mainpostimages/Category2.jpg" alt="GameFi">
                </div>
                <div style="font-weight: 500; color: black; font-size: 20px">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Experience"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px; flex: 1 0 18%; max-width: 18%;">
                    <img  style="flex: 1 0 18%; max-width: 18%;" class="card-img-top w-100 h-auto" src="admin/mainpostimages/Category3.jpg" alt="Experience">
                </div>
                <div style="font-weight: 500; color: black; font-size: 20px">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Knowledge"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px; flex: 1 0 18%; max-width: 18%;">
                    <img  style="flex: 1 0 18%; max-width: 18%;" class="card-img-top w-100 h-auto" src="admin/mainpostimages/Category4.jpg" alt="Knowledge">
                </div>
                <div style="font-weight: 500; color: black; font-size: 20px">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Analysis"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px; flex: 1 0 18%; max-width: 18%;">
                    <img  style="flex: 1 0 18%; max-width: 18%;" class="card-img-top w-100 h-auto" src="admin/mainpostimages/Category5.jpg" alt="Analysis">
                </div>
                <div style="font-weight: 500; color: black; font-size: 20px">
