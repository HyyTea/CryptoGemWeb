...
<!-- #region -->
    ...
    /* Giữ nguyên khoảng cách cho desktop */
    @media (min-width: 768px) {
        .col-md-2 {
            width: 18%; /* Giữ 18% cho các phần tử trên giao diện desktop */
            margin-bottom: 20px;
        }
    }

    /* Điều chỉnh khoảng cách cho giao diện mobile */
    @media (max-width: 768px) {
        .col-md-2 {
            width: 48%; /* Chiếm 48% trên màn hình nhỏ */
            margin-bottom: 10px; /* Giảm khoảng cách dưới mỗi phần tử */
        }

        .col-6 img {
            margin-bottom: 5px; /* Giảm khoảng cách giữa ảnh và tên category */
        }
