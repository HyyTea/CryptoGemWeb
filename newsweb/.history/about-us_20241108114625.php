...
<head>
    ...
    <style>
        ...
        /* Điều chỉnh cho màn hình di động */
            ...
            #teams .d-flex.justify-content-between {
                flex-direction: column;
                align-items: center;
            }

            #guest .d-flex.justify-content-between {
                flex-direction: column;
                align-items: center;
            }
    ...
    <div style="margin-top: 4%">
        ...
        <div class="px-5 py-5">
            ...
            <div id="about2" class="about mt-5 mb-5">
                ...
                <p class="mt-4" style="color: #555; font-style: italic">
                Thank you for taking a look at what we do.
                <br><br>
                Every day, CryptoGem journalists and analysts break news all the way around the world. But we also try to explain that world in all its complexities, so that you get the bigger picture. We cover more companies, industries and markets in more depth than anybody else, and we are always looking for the links between them.
                <br><br>
                As they say, context changes everything.
                </p>
                <a target="_blank" style="text-decoration: none;" href="https://t.me/HyyHwang"><div class="author text-right"><b>David Johnson</b>
                <span style="color: gray;"><br>D&E-in-Chief<br>CryptoGem</span></div></a>
            </div>
        ...
        <!-- Meet the Teams -->
        <div id="teams" class="px-5 py-5 text-center">
        ...
        <div id="guest" class="px-5 py-5">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        “I have always used CryptoGem they are a very professional organised company. The app is very easy and straightforward to use which I find is perfect. They are are very security conscious too, so you know you are always safe. I love this app. Well done CryptoGem.”
                        <div class="author text-right">- Lynne Timlett</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="px-5 py-5">
            <div class="post-header position-relative">
                ...
                <div id="contact" class="position-absolute" style="top: 70%; left: 50%; transform: translateX(-50%);">
                    <a href="https://t.me/HyyHwang" target="_blank" class="btn rounded-pill">Contact Us</a>
                </div>
            </div>
        </div>
