...
<div class="px-5 py-5">
    ...
    <?php
    // Kiểm tra nếu PostVideo chứa mã nhúng (iframe) hoặc URL video
    if (strpos($featuredVideo['PostVideo'], '<iframe') !== false) {
        ...
        echo '<iframe class="featured-video-iframe" src="' . $videoEmbedUrl . '" frameborder="0" allowfullscreen></iframe>';
    } else {
        // Nếu là file video tải lên
        echo '<video class="featured-video-frame" preload="none" controls>
                <source src="featurepostvideo/' . $featuredVideo['PostVideo'] . '" type="video/mp4">
              </video>';
    }
    ?>
</div>
