        ...
        <div class="px-5 py-5">
            <div class="container post-header">
                <div class="position-relative">
                    ...
                    <img class="card-img-top w-100 h-auto" src="admin/mainpostimages/Category5.jpg" alt="" style="max-height: 450px; object-fit: cover; border-radius: 25px;">
                    ...
                    <h2 class="text-center text-white position-absolute" style="top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 36px; font-weight: bold;">
                        ...
                        <a href="https://facebook.com" target="_blank" class="btn btn-primary mt-5">Connect on Facebook</a>
                    </h2>
