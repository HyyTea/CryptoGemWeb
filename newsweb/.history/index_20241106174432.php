...
<!-- #region -->
    ...
    @media (max-width: 768px) {
        /* Mobile: Bỏ flex và dùng col-6 để mỗi phần tử chiếm 50% chiều rộng */
        .col-md-2 {
            flex: none; /* Bỏ flex trên mobile */
            max-width: 100%; /* Chiếm toàn bộ chiều rộng */
            width: 48%; /* Mỗi phần tử chiếm 48% chiều rộng trên mobile */
        }
    }
    </style>
</head>
...
<div class="px-5 py-5">
    ...
    <div class="row d-flex justify-content-between flex-wrap">
        ...
        <div class="col-md-2 col-6 text-center mb-4" style="flex: 1 0 18%; max-width: 18%;">
