...
<div class="px-5 py-5">
    ...
    <div class="row d-flex justify-content-between flex-wrap">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a  style="flex: 1 0 18%; max-width: 18%;" class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Charts"); ?>">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a  style="flex: 1 0 18%; max-width: 18%;" class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("GameFi"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px;">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a  style="flex: 1 0 18%; max-width: 18%;" class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Experience"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px;">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a  style="flex: 1 0 18%; max-width: 18%;" class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Knowledge"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px;">
        ...
        <div class="col-md-2 col-6 text-center mb-4">
            <a  style="flex: 1 0 18%; max-width: 18%;" class="text-decoration-none" href="category.php?catid=<?php echo htmlentities("Analysis"); ?>">
                <div class="overflow-hidden" style="height: 100%; max-height: 764px;">
