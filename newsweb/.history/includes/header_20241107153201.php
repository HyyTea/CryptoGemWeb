    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .ml-3.position-relative {
                order: 1 !important; /* Đưa Search button ra sau navbar-toggler */
            }
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="d-flex justify-content-between align-items-center px-4 py-2" style="width: 100%;">
            ...
            <div class="ml-3 position-relative">
                ...
                <input type="text" id="search-input" class="form-control border rounded-pill" placeholder="Search" style="display: none; right: 0; top: 50%; transform: translateY(-50%); width: 200px;" onblur="toggleSearchInput()">
            </div>
        </div>
    </nav>
</header>
