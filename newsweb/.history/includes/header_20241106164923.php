...
<header id="header">
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="d-flex justify-content-between align-items-center px-4 py-2" style="width: 100%;">
            ...
            <div class="mx-auto" id="navbarResponsive">
                <div class="rounded-pill py-2 d-flex align-items-center collapse navbar-collapse" style="border: none; padding: 10px; background-color: #F2F2F2;">
