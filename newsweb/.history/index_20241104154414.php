...
<div id="lightbox-overlay" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.8); justify-content: center; align-items: center; z-index: 9999;">
    <div id="lightbox-content" style="position: relative; max-width: 90%; max-height: 90%;">
        <span id="lightbox-close" style="position: absolute; top: 10px; right: 10px; font-size: 24px; color: white; cursor: pointer;">&times;</span>
...
<script>// JavaScript xử lý mở lightbox
function openLightbox(videoHTML) {
...
// Sự kiện đóng lightbox khi bấm dấu "×" hoặc ngoài khung
...
document.getElementById('lightbox-overlay').onclick = function(event) {
...
// Mở lightbox khi bấm vào video
function playVideo(videoId) {
    const video = document.getElementById(videoId);
    const videoHTML = video.outerHTML;
    openLightbox(videoHTML);
}
</script>
