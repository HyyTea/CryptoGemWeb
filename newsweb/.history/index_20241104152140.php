...
<div class="py-5">
    ...
    <div class="video-wrapper">
        ...
        if (strpos($featuredVideo['PostVideo'], 'youtube.com') !== false || strpos($featuredVideo['PostVideo'], 'vimeo.com') !== false) {
            ...
            echo '<iframe id="featured-video" style="max-height: 100%; border-radius: 5%; width: 100%;" class="featured-video-iframe" src="' . htmlentities($videoEmbedUrl) . '" frameborder="0" allowfullscreen></iframe>';
        } else {
