    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-4">
                <h4 class="font-weight-bold" style="font-family: 'Playfair Display', serif; font-size: 2rem;">SIGN UP FOR</h4>
                <p class="ml-4" style="font-family: 'Playfair Display', serif; font-size: 1.5rem;">OUR NEWSLETTER</p>
