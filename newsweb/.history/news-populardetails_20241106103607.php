...
<head>
    ...
    <div class="row" style="gap: 20px;">
        ...
        foreach (array_slice($posts2, 0, 5) as $index => $post2) {
            ...
            echo '<a href="news-maindetails.php?nid=' . htmlentities($post2['pid4']) . '" class="text-decoration-none text-dark" style="display: block;">';
            ...
            echo '<img src="admin/mainpostimages/' . htmlentities($post2['PostImage']) . '" class="w-100 h-100" style="object-fit: cover;" alt="' . htmlentities($post2['posttitle4']) . '">';
            echo '</div>';
