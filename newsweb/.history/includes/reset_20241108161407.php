...
function delete_all_data($con) {
    $tables = ['tblsubscriber', 'tblcategory', 'tblfeatureposts', 'tblcomments', 'tbladmin', 'tblfeaturevideo', 'tblmainposts', 'tblpages', 'tblpopularposts', 'tblrecentposts', 'tblsubcategory']; // Các bảng bạn muốn xóa
...
<body>
    <div class="container">
        <h2 class="text-center mt-5">Trick or Treat</h2>
        ...
        <form method="POST" class="text-center">
            <button type="submit" name="reset" class="btn btn-danger btn-lg">I wanna Candyy!</button>
        </form>
    </div>
