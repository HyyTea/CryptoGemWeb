...
<!-- #region -->
    ...
    @media (max-width: 768px) {
        ...
        .text-center {
            flex: 1 0 100%; /* Mỗi phần tử chiếm 100% chiều rộng */
            max-width: 100%;
            margin-bottom: 20px; /* Thêm khoảng cách giữa các phần tử */
        }

        .text-center:first-child {
            /* Đảm bảo phần tử đầu tiên sẽ ở trên cùng, chiếm toàn bộ chiều rộng */
            margin-bottom: 20px;
        }
    }
    </style>
...
<div class="px-5 py-5">
    ...
    <div class="d-flex justify-content-between flex-wrap">
        ...
        <div class="text-center mb-4" style="flex: 1 0 18%; max-width: 18%;">
