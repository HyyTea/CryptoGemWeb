    ...
    <div style="margin-top: 4%">
        ...
        <div class="px-5 py-5">
            ...
            <div class="mt-5 text-center mb-5">
                ...
                <p style="font-size: 18px; color: #555; margin: 20px auto 0;">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    ...
                    <p style="font-size: 16px; color: #555; margin: 20px auto 0;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="text-left">
                    <p class="text-decoration-none">
                        ...
                        <div class="mt-2" style="font-weight: 500; color: black; font-size: 20px;">
                            George Cr.
                        </div>
        ...
        <div class="px-5 py-5">
            <div class="mt-5 text-center mb-5">
                <h2 style="font-weight: bold;">WHAT OUR GUESTS ARE SAYING</h2>
                <p style="font-size: 18px; color: #555; margin: 20px auto 0;">
                Curious about the experiences at CryptoGem? Discover firsthand what our guests are saying. From moments of pure delight to heartfelt testimonials, explore the stories that make every stay uniquely memorable.
                </p>
            </div>
            <div class="col-md-12 d-flex justify-content-between">
                <div class="col-md-4">
                    <div class="border-none p-4" style="background-color: #f0f0f0; border-radius: 20px;">
                        ...
                        <div class="text-right mt-2" style="font-size: 14px; color: gray; font-style: italic;">
                            - Chief Analyst
                        </div>
                    </div>
                </div>
        ...
        <div class="px-5 py-5">
            <div class="post-header">
                <div class="position-relative">
                    <!-- Hình ảnh chiếm toàn bộ chiều ngang -->
                    <img class="card-img-top w-100 h-auto" src="admin/mainpostimages/Category5.jpg" alt="" style="max-height: 450px;">
                    
                    <!-- Văn bản nằm đè lên hình ảnh -->
                    <h2 class="text-center text-white position-absolute" style="top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 36px; font-weight: bold;">
                        Let's Connect and Create Memorable Moments Together
                       
                    </h2> <a href="https://facebook.com" target="_blank" class="btn rounded-pill mt-3" style="background-color: white; color: #007bff; border: 2px solid #007bff;">
                            Contact Us
                        </a>
                    
                    <!-- Nút liên kết đến Facebook -->
                    <div class="text-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
