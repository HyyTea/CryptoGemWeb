...
?>
    ...
    <div class="card">
        <a href="news-maindetails.php?nid=<?php echo htmlentities($row1['pid1']) ?>" class="d-block text-decoration-none">
            <div class="overflow-hidden" style="height: 50%; max-height: 1300px">
                <img class="card-img-top w-100 h-auto" src="admin/mainpostimages/<?php echo htmlentities($row1['PostImage']); ?>" alt="<?php echo htmlentities($row1['posttitle1']) ?>" style="object-fit: cover; height: 100%;">
            </div>
