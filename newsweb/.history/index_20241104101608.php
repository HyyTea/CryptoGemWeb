...
<div class="px-5 py-5">
    ...
    <?php
    // Kiểm tra xem PostVideo là mã nhúng iframe hay URL
    if (strpos($featuredVideo['PostVideo'], '<iframe') !== false) {
        // Nếu là iframe, hiển thị trực tiếp
        echo html_entity_decode($featuredVideo['PostVideo']);

    } else if (strpos($featuredVideo['PostVideo'], 'youtube.com') !== false || strpos($featuredVideo['PostVideo'], 'vimeo.com') !== false) {
        // Nếu là URL YouTube/Vimeo, chuyển đổi thành mã nhúng
