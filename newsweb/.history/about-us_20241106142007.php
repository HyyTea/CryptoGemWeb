    ...
    <div class="px-5 py-5" style="margin-top: 4%">
        ...
        <div class="row mt-5">
            <div class="col-12 position-relative">
                ...
                <div class="position-absolute" style="top: 10%; left: 35%; right: 5%; color: #333; max-width: 70%;">
